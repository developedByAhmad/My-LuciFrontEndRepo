...
import ExpectedNOI from "./../bargraphs/ExpectedNOI"
import FirstYearReturns from '../bargraphs/FirstYearReturns';
// import ExpectedNotOperating from 'components/calculatorOne/report/reportOne/bargraphs/ExpectedNotOperating';
...
export default function ReportTwoDeskFive() {
          ...
          <Grid item container className={styles.divR4} xs={11} >
            <Grid item container xs={12} style={{backgroundColor:"#FFFFFF", padding: "15px"}}>
                <Grid item xs={8} style={{textAlign: "left", margin: "20px 5px"}} >
                    <p className={styles.h2R4}>Proforma STATEMENT :</p> <br />
                </Grid>
            ...
            <Grid item container xs={12} style={{marginTop:"50px"}}>
                <p className={styles.textR4}> Expected NOI operating income :</p> 
                <ExpectedNOI style={{marginLeft:"30px"}}/>
            </Grid> 

            <Grid item container xs={12} style={{marginTop:"50px"}}>
                <p className={styles.textR4}> First - Year Returns :</p> 
                <FirstYearReturns style={{marginLeft:"30px"}}/>
            </Grid> 
